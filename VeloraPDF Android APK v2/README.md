# VeloraPDF Android WebView APK v2.1.5
...
The current v2.1.5 APKs are stored in the root `downloads/` folder:

| Device / CPU | APK |
| --- | --- |
| Most modern phones and tablets, 64-bit ARM | [`downloads/Velora-PDF-Android-v2.1.5-arm64-v8a.apk`](../downloads/Velora-PDF-Android-v2.1.5-arm64-v8a.apk) |
| Older 32-bit ARM phones and tablets | [`downloads/Velora-PDF-Android-v2.1.5-armeabi-v7a.apk`](../downloads/Velora-PDF-Android-v2.1.5-armeabi-v7a.apk) |
| Android emulator / 32-bit x86 | [`downloads/Velora-PDF-Android-v2.1.5-x86.apk`](../downloads/Velora-PDF-Android-v2.1.5-x86.apk) |
| Android emulator / 64-bit x86 | [`downloads/Velora-PDF-Android-v2.1.5-x86_64.apk`](../downloads/Velora-PDF-Android-v2.1.5-x86_64.apk) |

They are also copied locally to:

```text
/Users/mutlu/Desktop/Velora-PDF-Android-APK-v2.1.5/
```
...
```bash
cp "VeloraPDF Android APK v2/app/build/outputs/apk/release/app-armeabi-v7a-release.apk" downloads/Velora-PDF-Android-v2.1.5-armeabi-v7a.apk
cp "VeloraPDF Android APK v2/app/build/outputs/apk/release/app-arm64-v8a-release.apk" downloads/Velora-PDF-Android-v2.1.5-arm64-v8a.apk
cp "VeloraPDF Android APK v2/app/build/outputs/apk/release/app-x86-release.apk" downloads/Velora-PDF-Android-v2.1.5-x86.apk
cp "VeloraPDF Android APK v2/app/build/outputs/apk/release/app-x86_64-release.apk" downloads/Velora-PDF-Android-v2.1.5-x86_64.apk
```
