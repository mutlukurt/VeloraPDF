...
| Device | Download |
| --- | --- |
| Windows 10/11 x64 | [Velora-PDF-1.0.53-x64-setup.exe](Velora-PDF-1.0.53-x64-setup.exe) |

This Windows build makes deleting (archiving) a page instant by updating only that page's search rows instead of rebuilding the whole search index. Renaming a page is faster for the same reason. It keeps the save-on-close, instant window reveal, code-split bundle, and single-transaction backup import from the previous releases.
...
7336c0bf3fb418d489543be0c0d48e7e737f70921ec5589d6fbc8bb3d4666ffd  Velora-PDF-1.0.53-x64-setup.exe
