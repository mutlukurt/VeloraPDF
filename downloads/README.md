...
| Device | Download |
| --- | --- |
| Windows 10/11 x64 | [Velora-PDF-1.0.47-x64-setup.exe](Velora-PDF-1.0.47-x64-setup.exe) |

This Windows build includes the desktop import/export fix for PDF open/save, annotated PDF export, Velora JSON sidecars, workspace backup import/export, and Settings archive downloads.
...
3ca2b78af26476fdc39ee067befba9556d722174499a3d8b5ab0b0c8f7d0a2ee  Velora-PDF-1.0.47-x64-setup.exe
